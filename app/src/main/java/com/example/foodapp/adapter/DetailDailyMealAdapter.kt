...
class DetailDailyMealAdapter(val context: Context, val list: ArrayList<ProductModel>?, val listener: OnItemDetailDailyMeal) :
    RecyclerView.Adapter<DetailDailyMealAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.detail_daily_meal_item, viewGroup, false)
